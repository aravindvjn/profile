  ...
  return (
    <Animation>
      <div className="home-content">
        ...
        <br />
        <p>
          I am a passionate {year || 22} year old Full-Stack Web Developer
          skilled in{" "}
          <strong>
          ...
          concept to deployment. While my expertise is in web development, I
          also have experience with <strong>React Native</strong> for
          cross-platform mobile development. As a{" "}
          <strong>Cybersecurity Enthusiast</strong>, I am also exploring
          security practices to enhance application safety. My focus is on
