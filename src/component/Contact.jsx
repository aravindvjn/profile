  ...
  return (
    <div className="home-content">
      ...
      <div className="contact-div">
        <a
          target="_blank"
          href="https://api.whatsapp.com/send/?phone=%2B917559027982&text&type=phone_number&app_absent=0"
          className="contact-child-div"
        >
        ...
        <a
          target="_blank"
          href="mailto:aravind284479@gmail.com"
          className="contact-child-div"
        >
        ...
        <a
          target="_blank"
          href="https://www.instagram.com/6windh"
          className="contact-child-div"
        >
